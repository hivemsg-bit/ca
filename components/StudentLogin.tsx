  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (isSignUp) {
        ...
        // 4. Save to Firestore (Live Database)
      ...
      // Store email for basic session persistence (Auth state handled by Firebase listener)
      ...
      if (err.code === 'auth/invalid-credential') msg = "Invalid email or password. If you are new, please create an account.";
